...
Future<List<PlayerResult>> sessionGetGameResults({required Session that , dynamic hint});
...
Future<void> sessionSubmitAnswer({required Session that , required int answerId , required int questionId , dynamic hint});
...
@override Future<List<PlayerResult>> sessionGetGameResults({required Session that , dynamic hint})  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
...
@override Future<void> sessionSubmitAnswer({required Session that , required int answerId , required int questionId , dynamic hint})  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
...
final arr = raw as List<dynamic>;
                ...
                return PlayerResult(username: dco_decode_String(arr[0]),
...
final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return Question(question: dco_decode_String(arr[0]),
...
return PlayerResult(username: var_username, correctAnswerCount: var_correctAnswerCount, wrongAnswerCount: var_wrongAnswerCount, avgAnswerTime: var_avgAnswerTime); }
...
return Question(question: var_question, answers: var_answers); }
